    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active T3 Studio agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow T3 Studio to connect to T3 Studio servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow T3 Studio to access your camera so you can scan pairing QR codes.",
