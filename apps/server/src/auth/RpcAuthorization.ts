...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverCheckMcpHealth]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverSearchMcpRegistry]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.providerSwarmLaunchAgent]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerSwarmMessageAgent]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerSwarmStopAgent]: AuthOrchestrationOperateScope,
  [WS_METHODS.localImageGenerate]: AuthOrchestrationOperateScope,
  [WS_METHODS.shiryuGenFormatPrompt]: AuthOrchestrationOperateScope,
  [WS_METHODS.vcsDiscoverRepositories]: AuthOrchestrationReadScope,
