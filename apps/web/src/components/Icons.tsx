...
export const NvidiaIcon: Icon = ({ className, ...props }) => (
  <svg {...props} viewBox="0 0 24 24" className={cn("fill-[#76B900]", className)}>
    <path d="M8.95 7.1c3.5-1.05 6.45.28 7.8 2.3-1.72-1.45-4.5-2.25-7.13-1.22-2.4.94-3.8 2.78-4.25 4.02.8 1.85 2.72 3.56 5.34 4.03 2.47.45 4.75-.33 6.24-1.65-1.3 1.98-4.12 3.38-7.52 2.72-3.23-.63-5.5-2.75-6.43-5.1.8-2.06 2.78-4.15 5.95-5.1Zm1.1 2.15c2.48-.7 4.48.3 5.45 1.48-1.2-.85-3.07-1.25-4.77-.65-1.58.57-2.45 1.68-2.78 2.33.48.84 1.5 1.57 2.8 1.72 1.22.14 2.35-.28 3.1-.95-.68 1.03-2.2 1.72-3.95 1.4-1.82-.34-3.08-1.5-3.55-2.22.5-1.13 1.65-2.53 3.7-3.1Zm.88 1.75c1.2-.33 2.17.18 2.62.72-.56-.4-1.44-.58-2.22-.28-.7.27-1.08.77-1.23 1.05.23.35.68.62 1.23.67.53.05 1.02-.13 1.35-.4-.3.43-.94.72-1.7.57-.8-.15-1.35-.65-1.55-.97.22-.5.7-1.1 1.5-1.36Z" />
  </svg>
);
...
export const OllamaIcon: Icon = ({ className, ...props }) => (
  ...
  >
    <path d="M7.2 9.2V5.8c0-1.2.8-2.1 1.8-2.1s1.8.9 1.8 2.1v1.4h2.4V5.8c0-1.2.8-2.1 1.8-2.1s1.8.9 1.8 2.1v3.4" />
    <path d="M6 10.8c0-1.1.9-2 2-2h8c1.1 0 2 .9 2 2v6.1c0 1.9-1.6 3.4-3.5 3.4h-5C7.6 20.3 6 18.8 6 16.9v-6.1Z" />
    <path d="M9.2 13.2h.1M14.7 13.2h.1M9.4 16.4c1.7 1 3.5 1 5.2 0" />
  </svg>
);

export const OmniRouteIcon: Icon = ({ className, ...props }) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    className={cn("fill-none stroke-current", className)}
  ...
  >
    ...
    <path d="M7 12h3.2c3.8 0 3.4-7 6.8-7" />
    <path d="M7 12h3.2c3.8 0 3.4 7 6.8 7" />
  </svg>
);
